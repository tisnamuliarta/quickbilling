...
namespace TizDev\LaravelNuxt\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Http\Response;
use TizDev\LaravelNuxt\Exceptions\InvalidConfigurationException;
...
class NuxtController
{
     ...
     */
    public function getSpa(Request $request): Response
    {
