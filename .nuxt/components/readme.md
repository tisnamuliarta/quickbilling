...
- `<SetupPermissions>` | `<setup-permissions>` (components/Setup/Permissions.vue)
- `<SetupRoles>` | `<setup-roles>` (components/Setup/Roles.vue)
- `<SetupTax>` | `<setup-tax>` (components/Setup/Tax.vue)
- `<SetupUsers>` | `<setup-users>` (components/Setup/Users.vue)
- `<SheetJSpreadSheet>` | `<sheet-j-spread-sheet>` (components/Sheet/JSpreadSheet.vue)
