...
use App\Services\Payroll\DeductionService;
...
{
    public DeductionService $service;

    /**
     * MasterUserController constructor.
     */
    public function __construct(DeductionService $service)
    {
    ...
    {
        $result = [];
        $result['form'] = $this->form('deductions');
    ...
    public function store(StoreDeductionRequest $request): JsonResponse
    {
        DB::beginTransaction();
        try {
            Deduction::create($this->service->formData($request, 'store'));
