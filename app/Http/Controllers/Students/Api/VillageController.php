...
class VillageController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $row_data = isset($options->itemsPerPage) ? (int)$options->itemsPerPage : 1000000000;
        ...
        $result = array();
        $query = Village::orderBy($sorts, $order);
        ...
        $regency_by_province = Village::where("district_id", "=", $request->district_id)->get();
    ...
    {
        $details = Village::where("id", "=", $id)->first();
        if ($details) {
