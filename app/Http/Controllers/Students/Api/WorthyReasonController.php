...
use App\Models\Student\KipWorthyReason;
use Carbon\Carbon;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class WorthyReasonController extends Controller
{
    /**
    ...
    public function index(Request $request): \Illuminate\Http\JsonResponse
    {
        ...
        $result = array();
        $query = KipWorthyReason::orderBy($sorts, $order);
    ...
    {
        $data = KipWorthyReason::where("id", "=", $id)->first();
        return response()->json([
            'rows' => $data
        ]);
    }
    ...
    {
        $details = KipWorthyReason::where("id", "=", $id)->first();
        if ($details) {
            KipWorthyReason::where("id", "=", $id)->delete();
            return response()->json([
                'message' => 'Row deleted'
            ]);
        }
