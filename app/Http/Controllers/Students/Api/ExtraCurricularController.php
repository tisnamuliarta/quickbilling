...
use App\Models\Student\Extracurricular;
use Carbon\Carbon;
...
class ExtraCurricularController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $result = array();
        $query = Extracurricular::orderBy($sorts, $order);
    ...
    {
        $details = Extracurricular::where("id", "=", $id)->first();
        if ($details) {
            Extracurricular::where("id", "=", $id)->delete();
            return response()->json([
                'message' => 'Row deleted'
            ]);
        }
