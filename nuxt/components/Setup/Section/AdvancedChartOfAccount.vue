<template>
  <v-row no-gutters>
    <v-col cols="12" md="2" class="pa-1">
      <span class="text-subtitle-1">Chart of accounts</span>
    </v-col>
        ...
        <template #content>
          <v-row no-gutters @click="companyNameView = false">
            ...
            <v-col cols="12" md="8" class="pa-2">
              <span class="text-subtitle-2" v-text="$formatter.formatCheckBox(form.advance_chart_of_account_number)"></span>
            </v-col>
          </v-row>
        </template>
      </FormSectionView>
        ...
        <template #content>
          <v-row no-gutters>
            <v-col cols="12" md="5" class="pa-2">
              <v-checkbox
                v-model="form.advance_chart_of_account_number"
