        ...
        <template #content>
          <v-row no-gutters>
            <v-col cols="4" class="pa-2">
              <v-checkbox
                v-model="form.sales_use_greeting"
                label="Use Greeting"
                hide-details="auto"
              ></v-checkbox>
            </v-col>
            ...
            <v-col cols="4" class="pa-2">
              <v-select
                label="Greeting"
                v-model="form.sales_message_greeting"
                :items="itemGreeting"
                filled
                dense
                hide-details="auto"
            ...
            <v-col cols="4" class="pa-2">
              <v-select
                label="Greeting Name"
                v-model="form.sales_greeting_name"
                :items="itemName"
                filled
                dense
                hide-details="auto"
            ...
            <v-col cols="4" class="pa-2">
              <v-select
                label="Sales Form"
                v-model="form.sales_message_form"
                :items="itemForm"
                filled
                dense
                hide-details="auto"
            ...
            <v-col cols="12" class="pa-2">
              <v-text-field
                ...
                v-model="form.sales_message_subject_line"
                filled
                dense
                hide-details="auto"
              ></v-text-field>
            ...
            <v-col cols="12" class="pa-2">
              <v-textarea
                label="Email Message"
                v-model="form.sales_message_content"
                filled
                dense
                hide-details="auto"
              ></v-textarea>
            ...
            <v-col cols="12" class="pa-2">
              <v-checkbox
                v-model="form.sales_message_email_copy"
            ...
            <v-col cols="12" class="pa-2">
              <v-text-field
                label="Copy (CC) new email to address"
                placehoder="CC (Separate multiple email with comma)"
                v-model="form.sales_message_cc"
                filled
                dense
                hide-details="auto"
              ></v-text-field>
            ...
            <v-col cols="12" class="pa-2">
              <v-text-field
                label="Blind Copy (Bcc) new email to address"
                placehoder="Bcc (Separate multiple email with comma)"
                v-model="form.sales_message_bcc"
                filled
                dense
                hide-details="auto"
              ></v-text-field>
