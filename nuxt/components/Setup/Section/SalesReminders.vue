<template>
  <v-row no-gutters>
    <v-col cols="12" md="2" class="pa-1">
      <span class="text-subtitle-1">Reminders</span>
    </v-col>
        ...
        <template #content>
          <v-row no-gutters>
            <v-col cols="4" class="pa-2">
              <v-checkbox
                v-model="form.sales_reminder_use_greeting"
                label="Use Greeting"
                hide-details="auto"
              ></v-checkbox>
            </v-col>
            ...
            <v-col cols="4" class="pa-2">
              <v-select
                label="Greeting"
                v-model="form.sales_reminder_greeting"
                :items="itemGreeting"
                filled
                dense
                hide-details="auto"
            ...
            <v-col cols="4" class="pa-2">
              <v-select
                label="Greeting Name"
                v-model="form.sales_reminder_greeting_name"
                :items="itemName"
                filled
                dense
                hide-details="auto"
            ...
            <v-col cols="12" class="pa-2">
              <v-text-field
                ...
                v-model="form.sales_reminder_subject"
                filled
                dense
                hide-details="auto"
              ></v-text-field>
            ...
            <v-col cols="12" class="pa-2">
              <v-textarea
                label="Email Message"
                v-model="form.sales_reminder_content"
                filled
                dense
                hide-details="auto"
              ></v-textarea>
            ...
            <v-col cols="12" class="pa-2">
              <v-checkbox
                v-model="form.sales_reminder_copy_email"
