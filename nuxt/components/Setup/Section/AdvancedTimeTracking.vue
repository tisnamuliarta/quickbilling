<template>
  <v-row no-gutters>
    <v-col cols="12" md="2" class="pa-1">
      <span class="text-subtitle-1">Time tracking</span>
    </v-col>
        ...
        <template #content>
          <v-row no-gutters @click="companyNameView = false">
            <v-col cols="12" md="4" class="pa-2 font-weight-medium">
              Add service field to timesheet
            </v-col>
            <v-col cols="12" md="8" class="pa-2">
              <span class="text-subtitle-2" v-text="$formatter.formatCheckBox(form.advanced_timesheets)"></span>
            </v-col>

            <v-col cols="12" md="4" class="pa-2 font-weight-medium">
              Make single-time activity billable to customer
            </v-col>
            <v-col cols="12" md="8" class="pa-2">
              <span class="text-subtitle-2" v-text="$formatter.formatCheckBox(form.advanced_single_timesheets)"></span>
            </v-col>
          </v-row>
        </template>
      </FormSectionView>
        ...
        <template #content>
          <v-row no-gutters>
            <v-col cols="12" md="5" class="pa-2">
              <v-checkbox
                v-model="form.advanced_timesheets"
                label="Add service field to timesheet"
                hide-details="auto"
              ></v-checkbox>
            </v-col>
            ...
            <v-col cols="12" md="5" class="pa-2">
              <v-checkbox
                v-model="form.advanced_single_timesheets"
                label="Make single-time activity billable to customer"
                hide-details="auto"
              ></v-checkbox>
            </v-col>
            <v-col cols="12" md="7" class="pa-2">
