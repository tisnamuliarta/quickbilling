<template>
  <v-row no-gutters>
    <v-col cols="12" md="2" class="pa-1">
      <span class="text-subtitle-1">Company Bank</span>
    </v-col>
          ...
          <v-container @click="companyNameView = false">
            <v-row no-gutters>
              ...
              <v-col cols="12" md="8" class="pa-2">
                 <span v-text="form.company_bank_name"></span>
              </v-col>
              ...
              >
              <v-col cols="12" md="8" class="pa-2">
                <span v-text="form.company_bank_branch"></span>
              </v-col>
              ...
              >
              <v-col cols="12" md="8" class="pa-2">
                <span v-text="form.company_bank_address"></span>
              </v-col>

               <v-col cols="12" md="4" class="pa-2 font-weight-bold"
                >Bank Account Number</v-col
              >
              <v-col cols="12" md="8" class="pa-2">
                <span v-text="form.company_bank_account_number"></span>
              </v-col>

              <v-col cols="12" md="4" class="pa-2 font-weight-bold"
                >Bank Account Name</v-col
              >
              <v-col cols="12" md="8" class="pa-2">
                <span v-text="form.company_bank_account_name"></span>
              </v-col>
            </v-row>
          </v-container>
        </template>
          ...
          <v-container>
            <v-row no-gutters>
              ...
              <v-col cols="12" md="5" class="pa-2">
                <v-list-item two-line class="pa-0">
                  <v-list-item-content>
                    <v-list-item-title>Bank Branch</v-list-item-title>
                  </v-list-item-content>
                </v-list-item>
              </v-col>
              <v-col cols="12" md="7" class="pa-2">
              ...
              <v-col cols="12" md="5" class="pa-2">Bank Address</v-col>
              <v-col cols="12" md="7" class="pa-2">
                <v-text-field
                  label="Address"
